...
public class Combobox<E> extends JComboBox<E> {
    ...
    public Combobox() {
        ...
        setBorder(new EmptyBorder(3, 7, 3, 7)); //setBorder(new EmptyBorder(15, 3, 5, 3));
        ...
        setRenderer(new DefaultListCellRenderer() {
            ...
            public Component getListCellRendererComponent(JList<?> jlist, Object o, int i, boolean bln, boolean bln1) {
                ...
                if (bln) {
                    com.setBackground(new Color(3, 155, 216)); //(240, 240, 240)
                }
                return com;
            }
        });
        ...
        protected ComboPopup createPopup() {
            BasicComboPopup pop = new BasicComboPopup(comboBox) {
                ...
                protected JScrollPane createScroller() {
                    list.setFixedCellHeight(20); //list.setFixedCellHeight(30);
                    JScrollPane scroll = new JScrollPane(list);
                    scroll.setBackground(Color.WHITE);
                    ScrollBarCustom sb = new ScrollBarCustom();
                    sb.setUnitIncrement(30);
                    sb.setForeground(new Color(0, 0, 0)); //(180, 180, 180)
